...
module.exports = "<!--The content below is only a placeholder and can be replaced.-->\r\n<div style=\"text-align:center\">\r\n  <h1>\r\n    Welcome to {{ title }}!\r\n  </h1>\r\n  <img width=\"300\"\r\n       alt=\"Angular Logo\"\r\n       src=\"data:image/svg+xml;base64,\">\r\n</div>\r\n\r\n<div class=\"demo\">\r\n  <div class=\"today\">\r\n    <h2>{{ now | date:'long' }}</h2>\r\n    <button (click)=\"updateTime()\">Update Time</button>\r\n  </div>\r\n  <div class=\"hide-show\">\r\n    <h2>Some Nonesense</h2>\r\n    <div *ngIf=\"!getHidden()\">\r\n      <iframe src=\"https://giphy.com/embed/hHZEsQS4PrBFC\"\r\n              width=\"480\"\r\n              height=\"480\"\r\n              frameBorder=\"0\"\r\n              class=\"giphy-embed\"\r\n              allowFullScreen></iframe>\r\n    </div>\r\n    <div *ngIf=\"getHidden()\">\r\n      <iframe src=\"https://giphy.com/embed/5nkIn9AEfUQ6JtXL43\"\r\n              width=\"480\"\r\n              height=\"480\"\r\n              frameBorder=\"0\"\r\n              class=\"giphy-embed\"\r\n              allowFullScreen></iframe>\r\n    </div>\r\n    <button (click)=\"toggleHidden()\">Toggle Cuteness</button>\r\n  </div>\r\n\r\n  <div class=\"list\">\r\n    <h2>{{ companies.length | pluralize:'A Cool Place':'Some Cool Places'}} to Work</h2>\r\n    <ul>\r\n      <li *ngFor=\"let company of companies\">{{ company }}</li>\r\n    </ul>\r\n  </div>\r\n</div>\r\n\r\n<app-test>Some random stuff from the parent</app-test>\r\n"
...
var AppComponent = /** @class */ (function () {
    function AppComponent() {
        ...
        this.now = new Date();
        this.hidden = false;
        this.companies = ['RoviSys'];
    }
    AppComponent.prototype.getHidden = function () {
        return this.hidden;
    };
...
/* harmony import */ var _pipes_pluralize_pipe__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./pipes/pluralize.pipe */ "./src/app/pipes/pluralize.pipe.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [
                ...
                _pipes_pluralize_pipe__WEBPACK_IMPORTED_MODULE_4__["PluralizePipe"],
...
module.exports = "<div>\r\n  From the test component\r\n</div>\r\n<ng-content></ng-content>\r\n<div>\r\n  More stuff from test component\r\n</div>\r\n"
...
var PluralizePipe = /** @class */ (function () {
    ...
    PluralizePipe.prototype.transform = function (value, singlularWord, pluralWord) {
...
module.exports = __webpack_require__(/*! C:\Users\mike.zrimsek\Documents\Tech Talks\angular-tech-talk\01_Templating\src\main.ts */"./src/main.ts");
